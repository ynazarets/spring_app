...
public class OrderServiceImpl implements OrderService {
    ...
    public void createNewOrder(Long userId, PlaceOrderRequestDto orderRequestDto) {
        ...
        ShoppingCart shoppingCart = shoppingCartRepository.findByUserIdWithBooksAndCartItems(userId)
                .orElseThrow(()
                        -> new EntityNotFoundException("Shopping cart not found for user with id: "
                        + userId)
        );
